...
INSERT INTO Transactions (TransactionID, AccountID, TransactionDate, Amount, Type) VALUES 
...
UPDATE Accounts SET ACCOUNTTYPE = NULL
WHERE ACCOUNTID IN(105, 112, 125, 128);


INSERT INTO Transactions (TransactionID, AccountID, TransactionDate, Amount, Type) VALUES (1005, 104, '2024-01-20',600, 'Credit');
