-- ====================================================================
-- PostgreSQL Setup Script for Data Migration Testing
-- Purpose: Create test database, schema, tables and sample data
-- ====================================================================

-- Step 1: Create Database (Run this as postgres superuser if needed)
-- Note: You may need to connect to 'postgres' database first to run this
...
CREATE TABLE IF NOT EXISTS test_schema.transactions (
    ...
    amount NUMERIC(12, 2),
    type VARCHAR(20),
    FOREIGN KEY (account_id) REFERENCES test_schema.accounts(account_id)
);

-- Loans Table
CREATE TABLE IF NOT EXISTS test_schema.loans (
...
-- Customers Data (40 records)
INSERT INTO test_schema.customers (customer_id, name, email, phone) VALUES
...
-- Accounts Data (40 records)
INSERT INTO test_schema.accounts (account_id, customer_id, account_type, balance) VALUES
...
-- Transactions Data (50 records)
INSERT INTO test_schema.transactions (transaction_id, account_id, transaction_date, amount, type) VALUES
...
-- Loans Data (30 records)
INSERT INTO test_schema.loans (loan_id, customer_id, loan_amount, interest_rate, start_date, end_date) VALUES
...
-- SELECT * FROM test_schema.customers LIMIT 5;
-- SELECT * FROM test_schema.accounts LIMIT 5;
-- SELECT * FROM test_schema.transactions LIMIT 5;
-- SELECT * FROM test_schema.loans LIMIT 5;
